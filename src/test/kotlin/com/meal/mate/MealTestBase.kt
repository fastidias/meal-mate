...
const val MEAL_DIRECTIONS_2 = "Die Zutaten für den Teig zusammenrühren und kurz ruhen lassen. Dann über eine Spätzle-Reibe in kochendes Wasser schaben."
...
open class MealTestBase {
    fun defaultMealItem1() = MealItem(MEAL_ID_1, MEAL_DIRECTIONS_1, MEAL_NAME_1, MEAL_INGREDIENTS_1, MEAL_IMAGE_URL_1)
    fun defaultMealItem2() = MealItem(MEAL_ID_2, MEAL_DIRECTIONS_2, MEAL_NAME_2, MEAL_INGREDIENTS_2, MEAL_IMAGE_URL_2)
