...
open class MealTestBase {
    fun defaultMealItem1() = MealDBO(MEAL_ID_1, MEAL_DIRECTIONS_1, MEAL_NAME_1, MEAL_INGREDIENTS_1, MEAL_IMAGE_URL_1)
    fun defaultMealItem2() = MealDBO(MEAL_ID_2, MEAL_DIRECTIONS_2, MEAL_NAME_2, MEAL_INGREDIENTS_2, MEAL_IMAGE_URL_2)
