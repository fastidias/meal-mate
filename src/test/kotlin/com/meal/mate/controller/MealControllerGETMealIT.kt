        ...
        mockMvc.get("$PATH_MEALS/${mealItem.id}")
            ...
            .andExpect {
                ...
                content {
                    ...
                    json(
                        """
                        {"data":{"name":"Knoblauchspaghetti mit frischen Tomaten","portionSize":1,"directions":"Sauerkraut","ingredients":[{"name":"Spaghetti","quantity":"500","unit":"g"}],"source":"https://www.chefkoch.de/rezepte/168021072969366/Feuriges-Nudelgericht.html?zufall=on","imageSource":"https://www.searchenginejournal.com/wp-content/uploads/2022/06/image-search-1600-x-840-px-62c6dc4ff1eee-sej-760x400.webp"},"meta":{"id":"4d259eda-8318-463c-9d5f-ed1cd74b2e24"}}
                        """
                    )
                }
            }
